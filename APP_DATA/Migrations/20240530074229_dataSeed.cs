    ...
    public partial class dataSeed : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "ShoesDetails_Sizes",
                keyColumn: "ID",
                keyValue: new Guid("20659f4b-4e3f-46d0-b821-9b16e9e2e427"));

            migrationBuilder.DeleteData(
                table: "ShoesDetails_Sizes",
                keyColumn: "ID",
                keyValue: new Guid("5ed45046-8532-4312-a902-b4afcbe9f4c1"));

            migrationBuilder.DeleteData(
                table: "ShoesDetails_Sizes",
                keyColumn: "ID",
                keyValue: new Guid("6865902a-2727-410f-9a86-64a36ab2d85b"));

            migrationBuilder.DeleteData(
                table: "ShoesDetails_Sizes",
                keyColumn: "ID",
                keyValue: new Guid("759ae7df-f8f4-4d00-8e28-3e6949d3d2e9"));

            migrationBuilder.DeleteData(
                table: "ShoesDetails_Sizes",
                keyColumn: "ID",
                keyValue: new Guid("c5ce4aaf-83ee-4371-b4e2-93b02f1cfaa6"));
